...
def apply_pose_estimate(image1,net,fname,writer):
    ...
    for i in range(len(personwiseKeypoints)):
        ...
        scolor=webcolors.rgb_to_name((colors1[s][2],colors1[s][1],colors1[s][0]))
        writer.writerow([fname,distance_vector[2],distance_vector[5],distance_vector[6],distance_vector[3],distance_vector[7],distance_vector[4],distance_vector[11],distance_vector[8],distance_vector[12],distance_vector[9],distance_vector[13],distance_vector[10],scolor,'NV'])
        s = (s + 1) % 8
    j=0
    for n in range(len(personwiseKeypoints)):
        for i in range(17):
            ...
            cv2.line(frameClone, (B[0], A[0]), (B[1], A[1]), colors1[j], 3, cv2.LINE_AA)
        j=(j+1)%8
